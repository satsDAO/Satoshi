...
describe('[Satoshi]', () => {
  ...
  describe('[deposit]', () => {
    ...
    it('different state #2', async () => {
      ...
      const satsAmount1 = '1';
      await SATS.connect(user).mint(satsAmount1, user.address)

      const satsAmount2 = '100000000';
      await SATS.connect(deployer).mint(satsAmount2, deployer.address)
